...
- [Building Agentic Applications with CrewAI and MCP](https://www.manning.com/books/building-agentic-applications-with-crewai-and-mcp) - A practical, example-driven guide to designing AI systems that plan, collaborate, use tools, and connect to real software environments.
